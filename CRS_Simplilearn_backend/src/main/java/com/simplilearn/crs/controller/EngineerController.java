...
import com.simplilearn.crs.service.EngineerService;
...
public class EngineerController {
	...
	public List<Engineer> getAllEngineers(){
		List<Engineer> engineers = (List<Engineer>) engineerService.fetchAllEngineers();
		return engineers;
	}
	...
	public @ResponseBody void addEngineer(@RequestBody Engineer engineer) {
	...
	public @ResponseBody void deleteEngineer(@PathVariable("engineerEmail") String email) {
		Engineer engineer =engineerService.findEngineerById(email);
